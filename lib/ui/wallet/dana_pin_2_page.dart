...
class DanaPin2Page extends StatefulWidget {
  const DanaPin2Page({Key? key}) : super(key: key);

  @override
  State<DanaPin2Page> createState() => _DanaPin2PageState();
}

class _DanaPin2PageState extends State<DanaPin2Page> {
  void initState() {
    AwaitingScreen();
  }
